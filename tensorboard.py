...
__all__=['GANSaveCallback', 'LearnerTensorboardWriter', 'GANTensorboardWriter', 'ImageGenTensorboardWriter']
...
class LearnerTensorboardWriter(LearnerCallback):
    ...
    def on_batch_end(self, last_loss:Tensor, iteration:int, train:bool, **kwargs)->None:
        ...
        #print (self.loss_iters, self.hist_iters)
        #self.tbwriter.flush()
